...
var inversify_express_utils_1 = __webpack_require__(3);
var authController_1 = __webpack_require__(14);
...
exports.mainModule = new inversify_1.ContainerModule(function (bind, _unbind, _isBound, _rebind, _unbindAsync, _onActivation, _onDeactivation) {
  ...
  bind(interfaces_1.TYPES.Fetch).to(Request_1.Request).inSingletonScope();
});
...
var express_1 = tslib_1.__importDefault(__webpack_require__(10));
var mongoose_1 = tslib_1.__importDefault(__webpack_require__(1));
var HttpServer_1 = __webpack_require__(11);
var containerDI_1 = __webpack_require__(6);
function start() {
...
var errorHandlingMiddleware_1 = __webpack_require__(12);
// import { mongoURI, port } from './../../config/default.json'
var interfaces_1 = __webpack_require__(5);
var inversify_express_utils_1 = __webpack_require__(3);
var containerDI_1 = __webpack_require__(6);
var cors_1 = tslib_1.__importDefault(__webpack_require__(20));
...
var jsonwebtoken_1 = tslib_1.__importDefault(__webpack_require__(4));
var inversify_express_utils_1 = __webpack_require__(3);
var authMiddleware_1 = __webpack_require__(17);
  ...
  _createClass(AuthController, [{
    ...
    function () {
      var _registration = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
        var _req$body, email, password, username, candidate, user, json;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _req$body = req.body, email = _req$body.email, password = _req$body.password, username = _req$body.username; // if (!email || !password) {
              ...
              case 3:
                ...
                return _context.abrupt("return", next(ApiError_1.ApiError.badRequest('The User now exist')));
              case 6:
    ...
    value: function () {
      var _login = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
        var _req$body2, password, username, user, comparePassword, json;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _req$body2 = req.body, password = _req$body2.password, username = _req$body2.username;
                _context2.next = 3;
                return User_1.User.findOne({
                  username: username
                });
              case 3:
                ...
                return _context2.abrupt("return", next(ApiError_1.ApiError.internal('User not a found')));
              case 6:
                _context2.next = 8;
              ...
              case 8:
                ...
                return _context2.abrupt("return", next(ApiError_1.ApiError.internal('Write correct password')));
              case 11:
                json = user.toAuthJSON();
    ...
    key: "checkToken",
    value: function () {
      var _checkToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res, next) {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.prev = 0;
                debugger;
                return _context5.abrupt("return", res.send(req._user));
              case 5:
                _context5.prev = 5;
                _context5.t0 = _context5["catch"](0);
                return _context5.abrupt("return", next(ApiError_1.ApiError.notAuth('Token expired')));
              case 8:
              case "end":
      ...
      function checkToken(_x13, _x14, _x15) {
...
tslib_1.__decorate([(0, inversify_express_utils_1.httpGet)('/checkToken', authMiddleware_1.authMiddleWare), tslib_1.__metadata("design:type", Function), tslib_1.__metadata("design:paramtypes", [Object, Object, Object]), tslib_1.__metadata("design:returntype", Promise)], AuthController.prototype, "checkToken", null);
...
var bcryptjs_1 = tslib_1.__importDefault(__webpack_require__(16));
var jsonwebtoken_1 = tslib_1.__importDefault(__webpack_require__(4));
...
var ApiError_1 = __webpack_require__(2);
// import { jwtSecret } from './../../config/default.json'
function authMiddleWare(req, _sres, next) {
...
var tslib_1 = __webpack_require__(0);
var inversify_1 = __webpack_require__(7);
var node_fetch_1 = tslib_1.__importDefault(__webpack_require__(19));
      ...
      var _get = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", (0, node_fetch_1["default"])(url));
              case 1:
              case "end":
                return _context.stop();
            }
...
Request = tslib_1.__decorate([(0, inversify_1.injectable)()], Request);
